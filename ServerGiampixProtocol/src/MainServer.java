...
public static int[] getStatus (){
	...
	if(GPIO_00)status[0]=1;
	else if(!GPIO_00) status[0]=0;
	
	if(GPIO_01)status[1]=1;
	else if(!GPIO_01) status[1]=0;
	
	if(GPIO_02)status[2]=1;
	else if(!GPIO_02) status[2]=0;
	
	if(GPIO_03)status[3]=1;
	else if(!GPIO_03) status[3]=0;
	
	if(garage)status[4]=1;
	else if(!garage) status[4]=0;
	
	if(AllarmeGarage)status[5]=1;
	else if(!AllarmeGarage) status[5]=0;
